...
ORDA links to ActivityStreams2.0 rather than defining its own classes for social media data. As data providers publish their data catalogues in greater detail ORDA will be expanded to cover specific fields mentioned in data providers' catalogues. 
